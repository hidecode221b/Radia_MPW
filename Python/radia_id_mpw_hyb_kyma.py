...
class HybridWigParam(UndParam):
    ...
    """
    def __init__(self, period, n_poles, gap, mag_width=70, mag_height=[40, 40, 0], mag_chamfer=[10, 0, 10], pole_length=10, pole_width=70, pole_height=30, pole_chamfer=[10, 0, 10], ext_pole=[5, 0], ext_mag=[45, 0, 10], mag_mat='ndfeb', br=1.29, sep_exp=[0, 0, 0], pole_mat='fecov', mag_area_max=200, pole_area_max=100, mag_long_sub=[2, 2], pole_long_sub=[1, 1], mag_color=[[0, 1, 1],[0, 0.5, 1]], pole_color=[1, 0, 1], wig_build='full'):
        """
